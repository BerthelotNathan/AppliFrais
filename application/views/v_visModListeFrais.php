				...
				<?php
					...
					foreach ($lesFraisForfait as $unFrais)
					{
						...
						'<tr >
							...
							<td  class="quantites">
								<input required="required" onchange="calculTotal('.$idFrais.')" type="text" id="'.$idFrais.'" name="lesFrais['.$idFrais.']" size="10" maxlength="5" value="'.$quantite.'" class="justUneClasse"/>
							</td>
							<td  class="montants">
